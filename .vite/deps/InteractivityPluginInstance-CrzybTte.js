import { Bt as manageListener, Vt as safeDocument, Yr as visibilityChangeEvent, jt as executeOnSingleOrMultiple } from "./browser-D1s4r1_w.js";
import { a as mouseUpEvent, c as touchMoveEvent, d as Interactivity, f as InteractivityDetect, i as mouseMoveEvent, l as touchStartEvent, n as mouseDownEvent, o as touchCancelEvent, r as mouseLeaveEvent, s as touchEndEvent, t as clickEvent, u as InteractorType } from "./InteractivityConstants-D6y31Zim.js";
	...
	addClickHandler(callback) {
		...
		const clickOrTouchHandler = (e, pos, radius) => {
			...
			if (touched && !touchMoved) {
				...
				if (!lastTouch) return;
				const element = container.canvas.domElement, canvasRect = element ? element.getBoundingClientRect() : void 0;
				clickOrTouchHandler(e, {
...
//# sourceMappingURL=InteractivityPluginInstance-CrzybTte.js.map